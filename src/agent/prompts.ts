...
- **Cálculos agregados (Boss 2026-08-03 — calcular_cantidades):** cuando el usuario pide un total, suma, promedio, mínimo o máximo de una propiedad (ej: "área total de ventanas", "cuánto suma el volumen de muros", "volumen promedio de losas"), añade el campo calcular al objeto tabla. Estructura: calcular: {operacion: "suma" | "promedio" | "min" | "max", columna: "<etiqueta en español ya presente en columnas>"}. La columna DEBE ser una de las que ya pasaste en columnas. La tabla mostrará una fila "TOTAL" al final con el valor calculado y la unidad inferida (m², m³, m). En la prosa, reporta el valor exacto con su unidad: "El área total de las 7 ventanas es 15.228 m²."
